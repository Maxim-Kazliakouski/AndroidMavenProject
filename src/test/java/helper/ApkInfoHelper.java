...
public class ApkInfoHelper {
    ...
    public ApkInfoHelper() {
        String app = EmulatorPropertyReader.getProperty("app"); //читаем путь к apk из пропертей
        ...
        try {
            ...
            String pathToApt = "C:\\Users\\Selecty\\AppData\\Local\\Android\\Sdk\\build-tools\\33.0.1\\";
            apkInfo = executeSh(pathToApt + "aapt dump badging" + EmulatorPropertyReader.getProperty("app"));
